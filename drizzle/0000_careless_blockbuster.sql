CREATE TYPE "public"."difficulty_level" AS ENUM('junior', 'mid', 'senior');--> statement-breakpoint
CREATE TYPE "public"."interview_type" AS ENUM('behavioral', 'technical', 'mixed');--> statement-breakpoint
...
CREATE TABLE "interview_sessions" (
	...
	"interview_type" "interview_type" DEFAULT 'mixed' NOT NULL,
	"difficulty" "difficulty_level" DEFAULT 'junior' NOT NULL,
